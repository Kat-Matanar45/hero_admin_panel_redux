...
import { heroesFetched, fetchHeroes } from '../../reducers/heroesSlice';
...
const HeroesList = () => {
    const {heroes, heroesLoadingStatus, activID} = useSelector(state => state.heroes);
    const {activFilter} = useSelector(state => state.filters);
